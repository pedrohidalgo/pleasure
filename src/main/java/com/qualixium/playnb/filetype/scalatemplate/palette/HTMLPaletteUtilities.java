...
public class HTMLPaletteUtilities {
    public static boolean PREFIX_WITH_HELPER = false;
    public static String MY_FORM_VARIABLE_NAME = "myForm";
    ...
    private static int insert(String s, JTextComponent target, Document doc) throws BadLocationException {
        ...
        try {
            ...
            doc.remove(p0, p1 - p0); //then, replace selected text range with the inserted one: 
            start = caret.getDot();
