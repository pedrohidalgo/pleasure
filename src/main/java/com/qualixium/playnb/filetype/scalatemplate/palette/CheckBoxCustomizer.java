...
public class CheckBoxCustomizer extends javax.swing.JPanel {
     ...
     */
    public CheckBoxCustomizer(CheckBox checkBox, JTextComponent target) {
    ...
    @NbBundle.Messages({"LBL_Customizer_InsertPrefix_CheckBox=Insert CheckBox", "NAME_Play-CheckBox=CheckBox"})
    public boolean showDialog() {
        dialogOK = false;
        descriptor = new DialogDescriptor(this, Bundle.LBL_Customizer_InsertPrefix_CheckBox(), true, DialogDescriptor.OK_CANCEL_OPTION, DialogDescriptor.OK_OPTION, new ActionListener() {
            @Override
    ...
    private void evaluateInput() {
        ...
        checkBox.formVariableName = txtFormVariableName.getText();
        checkBox.name = txtName.getText();
        checkBox.id = txtId.getText();
        checkBox.label = txtLabel.getText();
        checkBox.clazz = txtClass.getText();
        checkBox.disabled = chDisabled.isSelected();
        checkBox.checked = chChecked.isSelected();
        checkBox.required = chRequired.isSelected();
    }

    private void myOwnInitComponents() {
        chPrefixWithHelper.setSelected(HTMLPaletteUtilities.PREFIX_WITH_HELPER);
        txtClass.setText(checkBox.clazz == null ? "" : checkBox.clazz);
