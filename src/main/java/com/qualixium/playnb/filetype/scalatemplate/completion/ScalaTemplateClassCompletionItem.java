...
public class ScalaTemplateClassCompletionItem implements CompletionItem {

    private final String text;
    private static final ImageIcon fieldIcon = new ImageIcon(ImageUtilities.loadImage("com/qualixium/playnb/scala_icon_item.png"));
    private final int startOffset;
    private final int caretOffset;

    public ScalaTemplateClassCompletionItem(String text, int startOffset, int caretOffset) {
        this.text = text;
