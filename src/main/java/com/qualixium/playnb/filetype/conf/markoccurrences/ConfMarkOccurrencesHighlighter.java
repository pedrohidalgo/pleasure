...
public class ConfMarkOccurrencesHighlighter implements CaretListener {
    ...
    public ConfMarkOccurrencesHighlighter(Document doc) {
        rp = new RequestProcessor(ConfMarkOccurrencesHighlighter.class);
