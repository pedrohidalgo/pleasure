...
public class ConfReformatTask implements ReformatTask {

    private final Context context;

    public ConfReformatTask(Context context) {
...
//        int sbtIndentSpaces = NbPreferences.forModule(PlayPanel.class).getInt(SBT_INDENT_SPACES, 4);
        int indentSpaces = 4;
        String fileFormattedFinal = formatFile(fileContent, indentSpaces);
