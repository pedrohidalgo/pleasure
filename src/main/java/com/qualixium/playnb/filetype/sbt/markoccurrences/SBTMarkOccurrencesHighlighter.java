...
public class SBTMarkOccurrencesHighlighter implements CaretListener {
    ...
    public SBTMarkOccurrencesHighlighter(Document doc) {
        rp = new RequestProcessor(SBTMarkOccurrencesHighlighter.class);
