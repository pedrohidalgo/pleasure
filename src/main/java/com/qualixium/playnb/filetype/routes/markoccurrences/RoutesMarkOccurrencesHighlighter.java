...
public class RoutesMarkOccurrencesHighlighter implements CaretListener {
    ...
    public RoutesMarkOccurrencesHighlighter(Document doc) {
        rp = new RequestProcessor(RoutesMarkOccurrencesHighlighter.class);
