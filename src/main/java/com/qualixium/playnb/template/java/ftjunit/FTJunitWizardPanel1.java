...
public class FTJunitWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private FTJunitVisualPanel1 component;
    private final WizardDescriptor wizard;

    public FTJunitWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public FTJunitVisualPanel1 getComponent() {
        if (component == null) {
            component = new FTJunitVisualPanel1(wizard);
