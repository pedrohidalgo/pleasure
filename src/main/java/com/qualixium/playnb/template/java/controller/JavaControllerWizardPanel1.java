...
public class JavaControllerWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private JavaControllerVisualPanel1 component;
    private final WizardDescriptor wizard;

    public JavaControllerWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public JavaControllerVisualPanel1 getComponent() {
        if (component == null) {
            component = new JavaControllerVisualPanel1(wizard);
