 ...
 */
package com.qualixium.playnb.template.java.controller;
...
@TemplateRegistration(folder = PLAY_JAVA_FOLDER_TEMPLATES, displayName = "#JavaControllerWizardIterator_displayName", iconBase = "com/qualixium/playnb/template/java/class.png", description = "javaController.html")
@Messages("JavaControllerWizardIterator_displayName=Java Controller")
public final class JavaControllerWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new JavaControllerWizardPanel1(wizard));
