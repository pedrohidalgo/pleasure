package com.qualixium.playnb.template.scala.specs2;
...
@TemplateRegistration(folder = PLAY_SCALA_FOLDER_TEMPLATES, position = 6, displayName = "#Specs2WizardIterator_displayName",
        iconBase = "com/qualixium/playnb/template/scala/specs2/specs2_icon.png", description = "specs2.html")
@Messages("Specs2WizardIterator_displayName=Specs2")
public final class Specs2WizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new Specs2WizardPanel1(wizard));
