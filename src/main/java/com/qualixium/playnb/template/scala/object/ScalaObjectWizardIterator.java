package com.qualixium.playnb.template.scala.object;
...
@TemplateRegistration(folder = PLAY_SCALA_FOLDER_TEMPLATES, position = 1, displayName = "#ScalaObjectWizardIterator_displayName",
        iconBase = "com/qualixium/playnb/scala_icon_item.png",
        description = "scalaObject.html")
@Messages("ScalaObjectWizardIterator_displayName=Scala Object")
public final class ScalaObjectWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new ScalaObjectWizardPanel1(wizard));
    ...
    public Set<?> instantiate() throws IOException {
        ...
        return TemplateUtil.createTemplateFile(wizard, getSource(packageName, className), MiscUtil.Language.SCALA);
    }
