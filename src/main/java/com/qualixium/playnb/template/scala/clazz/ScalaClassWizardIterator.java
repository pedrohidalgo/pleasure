package com.qualixium.playnb.template.scala.clazz;
...
@TemplateRegistration(folder = PLAY_SCALA_FOLDER_TEMPLATES, position = 2, displayName = "#ScalaClassWizardIterator_displayName",
        iconBase = "com/qualixium/playnb/scala_icon_item.png",
        description = "scalaClass.html")
@Messages("ScalaClassWizardIterator_displayName=Scala Class")
public final class ScalaClassWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new ScalaClassWizardPanel1(wizard));
