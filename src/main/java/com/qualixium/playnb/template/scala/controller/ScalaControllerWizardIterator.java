...
@TemplateRegistration(folder = PLAY_SCALA_FOLDER_TEMPLATES, position = 3, displayName = "#ScalaControllerWizardIterator_displayName",
        iconBase = "com/qualixium/playnb/scala_icon_item.png",
        description = "scalaController.html")
@Messages("ScalaControllerWizardIterator_displayName=Scala Controller")
public final class ScalaControllerWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new ScalaControllerWizardPanel1(wizard));
