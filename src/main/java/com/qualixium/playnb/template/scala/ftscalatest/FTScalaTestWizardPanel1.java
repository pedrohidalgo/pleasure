package com.qualixium.playnb.template.scala.ftscalatest;
...
public class FTScalaTestWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private FTScalaTestVisualPanel1 component;
    private final WizardDescriptor wizard;

    public FTScalaTestWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public FTScalaTestVisualPanel1 getComponent() {
        if (component == null) {
            component = new FTScalaTestVisualPanel1(wizard);
