...
public class ScalaObjectWizardPanel1  implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private ScalaObjectVisualPanel1 component;
    private final WizardDescriptor wizard;

    ScalaObjectWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public ScalaObjectVisualPanel1 getComponent() {
        if (component == null) {
            component = new ScalaObjectVisualPanel1(wizard);
