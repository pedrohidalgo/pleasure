...
public class ScalaClassWizardPanel1  implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private ScalaClassVisualPanel1 component;
    private final WizardDescriptor wizard;

    ScalaClassWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public ScalaClassVisualPanel1 getComponent() {
        if (component == null) {
            component = new ScalaClassVisualPanel1(wizard);
