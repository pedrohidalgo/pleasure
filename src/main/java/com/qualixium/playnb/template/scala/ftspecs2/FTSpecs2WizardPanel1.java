...
public class FTSpecs2WizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private FTSpecs2VisualPanel1 component;
    private final WizardDescriptor wizard;

    public FTSpecs2WizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public FTSpecs2VisualPanel1 getComponent() {
        if (component == null) {
            component = new FTSpecs2VisualPanel1(wizard);
