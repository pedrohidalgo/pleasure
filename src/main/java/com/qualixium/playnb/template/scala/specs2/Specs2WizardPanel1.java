...
public class Specs2WizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private Specs2VisualPanel1 component;
    private final WizardDescriptor wizard;

    public Specs2WizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public Specs2VisualPanel1 getComponent() {
        if (component == null) {
            component = new Specs2VisualPanel1(wizard);
