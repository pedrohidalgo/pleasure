...
public class ScalaTestWizardPanel1 implements WizardDescriptor.ValidatingPanel<WizardDescriptor>, DocumentListener {
     ...
     */
    private ScalaTestVisualPanel1 component;
    private final WizardDescriptor wizard;

    public ScalaTestWizardPanel1(WizardDescriptor wizard) {
        this.wizard = wizard;
    }
    ...
    @Override
    public ScalaTestVisualPanel1 getComponent() {
        if (component == null) {
            component = new ScalaTestVisualPanel1(wizard);
